...
public class Transaction extends ChildMessage implements Serializable {
     ...
     */
    public static final Coin REFERENCE_DEFAULT_MIN_TX_FEE = CoinDefinition.DEFAULT_MIN_TX_FEE;//Coin.valueOf(1000);
     ...
     */
    public static final Coin MIN_NONDUST_OUTPUT = CoinDefinition.DUST_LIMIT;//Coin.valueOf(546);
